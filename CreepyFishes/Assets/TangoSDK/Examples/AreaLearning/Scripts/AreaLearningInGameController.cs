...
public class AreaLearningInGameController : MonoBehaviour, ITangoPose, ITangoEvent, ITangoDepth
{
    ...
    public void Update()
    {
        if (m_saveThread != null && m_saveThread.ThreadState != ThreadState.Running)
        {
            ...
            //_SaveMarkerToDisk();
            _SaveStageDataToDisk();
#pragma warning disable 618
            //UnityEngine.SceneManagement.SceneManager.LoadScene("Main");
            m_saveThread = null;
            //GetComponent<PhotonManager>().DisconnectPlayer();
            UIManager.gs = UIManager.guistate.LoadOrCreateMapMenu;
...
#pragma warning restore 618
    ...
    private void _LoadStageDataFromDist()
    {
        string path = Application.persistentDataPath + "/" + m_curAreaDescription.m_uuid + ".xml";
        var serializer = new XmlSerializer(typeof(StageData));
        var stream = new FileStream(path, FileMode.Open);
        StageData sd = serializer.Deserialize(stream) as StageData;
        if(sd == null)
        {
...
public class StageData
{
    public string UUID;
    //LeftWall
    public float positionLeftWallX;
    public float positionLeftWallY;
    public float positionLeftWallZ;

    public float scaleLeftWallX;
    public float scaleLeftWallY;
    public float scaleLeftWallZ;

    //RightWall
    public float positionRightWallX;
    public float positionRightWallY;
    public float positionRightWallZ;

    public float scaleRightWallX;
    public float scaleRightWallY;
    public float scaleRightWallZ;

    //RedArea
    public float positionRedAreaX;
    public float positionRedAreaY;
    public float positionRedAreaZ;

    public float scaleRedAreaX;
    public float scaleRedAreaY;
    public float scaleRedAreaZ;
    //BlueArea

    public float positionBlueAreaX;
    public float positionBlueAreaY;
    public float positionBlueAreaZ;

    public float scaleBlueAreaX;
    public float scaleBlueAreaY;
    public float scaleBlueAreaZ;
